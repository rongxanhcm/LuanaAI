...
Tôi đã tạo 3 version SVG icon cho web của bạn, mỗi cái dùng cho mục đích khác nhau:
...
**Cách dùng:**
```html
<img src="/icon.svg" alt="DocGen VN" style="width: 80px; height: 80px;">
<!-- Hoặc -->
...
**Cách dùng:**
```html
<img src="/icon-logo.svg" alt="DocGen VN Logo">
```
...
```html
<div class="logo">
  <img src="/icon-favicon.svg" alt="DocGen" style="width: 32px; height: 32px; margin-right: 8px; vertical-align: middle;">
...
```html
<meta property="og:image" content="https://docgen-vn.vercel.app/icon-logo.svg">
```
